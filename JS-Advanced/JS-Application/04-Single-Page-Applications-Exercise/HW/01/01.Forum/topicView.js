...
function createHtmlTopic(t) {
    ...
    //let format = time.getHours() > 12 ? 'PM' : 'AM';
    ...
    contentParagraph.textContent = t.post;

    headerDivElement.appendChild(profilePicElement);
    headerDivElement.appendChild(metaParagraphElement);
    headerDivElement.appendChild(contentParagraph);
